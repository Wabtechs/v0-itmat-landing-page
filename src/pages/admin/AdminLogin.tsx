      ...
      <div className="w-full max-w-md">
        <div className="glass-card rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-foreground">Administration ITMAT</h1>
            <p className="text-muted-foreground mt-2">Connectez-vous pour acceder au tableau de bord</p>
          </div>
